...
def main():
    ...
    print('module',len([module for module in model.modules()]),len([module for module in model.modules() if not isinstance(module,nn.Sequential)]), [module for module in model.modules() if not isinstance(module,nn.Sequential)][1])
