...
# the joint train learning rate needs to be messed around with more. Also, we need to see if cosine annealing makes the loss explode again (goes up to max lr after 10 epochs)
