...
parser.add_argument('--div-temp', default=1.0, type=float,
                    help='diversity temperature (default: 0.0)')
parser.add_argument('--div-weight', default=1.0, type=float,
                    help='diversity_weight (default: 1.0)')
...
training_configurations = {
    'resnet': {
        ...
        'batch_size': 2048, #1024, #if args.dataset in ['cifar10', 'svhn'] else 128,
...
exp_name = ('InfoPro*_' if args.balanced_memory else 'InfoPro_') \
              ...
              + ('_new_config') \
              + ('_1c2f_stride=2') \
              + (('_ens_' + str(args.ensemble_type)) if args.eval_ensemble else '')
